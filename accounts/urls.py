...
from .views import SignUpView, LoginView, EmailVerification, DashboardView, PasswordResetView,PasswordResetEmailView, CreateNewPasswordView, LogoutView, AccountCreatedView, AccountVerifiedView
